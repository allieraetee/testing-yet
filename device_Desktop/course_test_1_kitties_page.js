function init_Desktop() {
	...
	if( is.min ){
		...
		if( titleMgr ) {
		  if( !titleMgr.loadTest( '_tobj190', 'test190', 'course_test_1_kitties_page.html' )) {
		...
		if ( trivPageTracking.GetRangeStatus(272) == 'notstarted' ) trivPageTracking.SetRangeStatus(272,2);
	}
}
...
button12.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_puppies_page.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_math.html',true);
    if(typeof pF == 'function') pF(); }},
...
button200.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 823px; top: 536px; width: 60px; height: 29px; z-index: 19; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj200",
	bInsAnc:	1,
	cwObj:		{
...
button201.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 890px; top: 536px; width: 60px; height: 29px; z-index: 20; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj201",
	bInsAnc:	1,
	cwObj:		{
...
text387.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 242px; min-height: 28px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 242px; min-height: 28px;\"><p style=\"text-align:left\"><span style=\"font-family:\'Arial\',sans-serif;font-size:12pt;color:0\">*hint* True!- &nbsp;Double Duh!</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 170px; top: 243px; width: 242px; height: 28px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj387",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[170,243,242,28]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
qu273.rcdData.att_Desktop = 
{
	innerHtml:	"",
	cssText:	"",
	cssClasses:	"",
	...
	cwObj:		{
				...
				"varQuest":	VarQuestion_273
			},
	objData:	{"a":[0,32,0,[]]}
};
text282.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 435px; min-height: 20px;\"><legend><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 435px; min-height: 20px;\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">Kitties are adorable creatures.&nbsp;</span></p></div></legend></div>",
	cssText:	"visibility: inherit; position: absolute; left: 30px; top: 210px; width: 435px; height: 20px; z-index: 9;",
	cssClasses:	"",
	htmlId:		"tobj282",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	objData:	{"a":[0,32,0,[30,210,435,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
image281.rcdData.att_Desktop = 
{
	innerHtml:	"<img src=\"images/kitties.jpg\" style=\"position: absolute; left: 0px; top: 0px; width: 523px; height: 290px; border-style: none;\">",
	cssText:	"visibility: inherit; position: absolute; left: 438px; top: 226px; width: 523px; height: 290px; z-index: 10;",
	cssClasses:	"",
	htmlId:		"tobj281",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	cwObj:		{
				"arChld":
	[
		{type:6,on:0,delay:0, actItem:function(){ LMSTinCanStatement( 'petted', 'kitties')

    if(typeof pF == 'function') pF(); }}
	]
			},
	objData:	{"a":[1,288,0,[438,226,523,290]]}
};
text283.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 43px; min-height: 20px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 43px; min-height: 20px;\"><label for=\"rad284\" style=\"cursor:default\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">True</span></p></label></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 184px; top: 311px; width: 43px; height: 20px; z-index: 11;",
	cssClasses:	"",
	htmlId:		"tobj283",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	objData:	{"a":[0,32,0,[184,311,43,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
radio284.rcdData.att_Desktop = 
{
	innerHtml:	"<div style=\"white-space: nowrap; position: absolute; left: 0px; top: 0px; width: 19px; height: 19px;\"><input type=\"radio\" id=\"rad284\" name=\"rad273\" value=\"True\" onclick=\"VarQuestion_273.set(this.value);qu273.questionUpdated();\" style=\"background-image: url(&quot;images/trivantis-blank.gif&quot;);\"></div>",
	cssText:	"visibility: inherit; position: absolute; left: 156px; top: 308px; width: 19px; height: 19px; z-index: 12;",
	cssClasses:	"",
	htmlId:		"tobj284",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	objData:	{"a":[0,32,0,[156,308,19,19]],"formType":1,"dwFormFlags":0}
};
text285.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 49px; min-height: 20px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 49px; min-height: 20px;\"><label for=\"rad286\" style=\"cursor:default\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">False</span></p></label></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 184px; top: 356px; width: 49px; height: 20px; z-index: 13;",
	cssClasses:	"",
	htmlId:		"tobj285",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	objData:	{"a":[0,32,0,[184,356,49,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
radio286.rcdData.att_Desktop = 
{
	innerHtml:	"<div style=\"white-space: nowrap; position: absolute; left: 0px; top: 0px; width: 19px; height: 19px;\"><input type=\"radio\" id=\"rad286\" name=\"rad273\" value=\"False\" onclick=\"VarQuestion_273.set(this.value);qu273.questionUpdated();\" style=\"background-image: url(&quot;images/trivantis-blank.gif&quot;);\"></div>",
	cssText:	"visibility: inherit; position: absolute; left: 155px; top: 356px; width: 19px; height: 19px; z-index: 14;",
	cssClasses:	"",
	htmlId:		"tobj286",
	bInsAnc:	0,
	fieldsetId:	'fset273',
	objData:	{"a":[0,32,0,[155,356,19,19]],"formType":1,"dwFormFlags":0}
};
