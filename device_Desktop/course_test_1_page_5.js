function init_Desktop() {
	...
	if( is.min ){
		...
		if( titleMgr ) {
		  if( !titleMgr.loadTest( '_tobj190', 'test190', 'course_test_1_page_5.html' )) {
		...
		if ( trivPageTracking.GetRangeStatus(304) == 'notstarted' ) trivPageTracking.SetRangeStatus(304,2);
	}
}
...
button12.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_page_3.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_puppies_page.html',true);
    if(typeof pF == 'function') pF(); }},
...
button201.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 890px; top: 536px; width: 60px; height: 29px; z-index: 14; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj201",
	bInsAnc:	1,
	cwObj:		{
...
text305.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 718px; min-height: 168px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 718px; min-height: 168px;\"><p style=\"text-align:left\"><span style=\"font-size: 18pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">Make sure to use the \'back\' and \'next buttons for the test. &nbsp;Not the arrows.</span></p><p style=\"text-align:left\"><span>&nbsp;</span></p><p style=\"text-align:left\"><span>&nbsp;</span></p><p style=\"text-align:left\"><span>&nbsp;</span></p><p style=\"text-align:left\"><span style=\"font-size: 18pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">Go ahead and hit next to start!</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 120px; top: 296px; width: 718px; height: 168px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj305",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[120,296,718,168]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
