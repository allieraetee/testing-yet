function init_Desktop() {
	...
	if( is.min ){
		...
		if ( trivPageTracking.GetRangeStatus(189) == 'notstarted' ) trivPageTracking.SetRangeStatus(189,2);
	}
}
...
button12.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_favorite_color.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_page_5.html',true);
    if(typeof pF == 'function') pF(); }},
...
text326.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 659px; min-height: 242px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 659px; min-height: 242px;\"><p style=\"text-align: center;\"><span style=\"font-size: 48pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">Now on to the harder questions!</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 146px; top: 242px; width: 659px; height: 242px; z-index: 7;",
	cssClasses:	"",
	htmlId:		"tobj326",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[146,242,659,242]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
text322.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 776px; top: 553px; width: 200px; height: 27px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj322",
	bInsAnc:	0,
