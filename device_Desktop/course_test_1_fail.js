function init_Desktop() {
	...
	if( is.min ){
		...
		if ( trivPageTracking.GetRangeStatus(217) == 'notstarted' ) trivPageTracking.SetRangeStatus(217,2);
	}
}
...
button12.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_pass.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_page_4.html',true);
    if(typeof pF == 'function') pF(); }},
...
text309.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 724px; min-height: 288px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 724px; min-height: 288px;\"><p style=\"text-align: center;\"><span style=\"font-size: 72pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">You Failed!</span></p><p style=\"text-align: center;\"><span style=\"font-size: 72pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">Sorry...not sorry!</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 150px; top: 215px; width: 724px; height: 288px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj309",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[150,215,724,288]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
