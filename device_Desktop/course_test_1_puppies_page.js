function init_Desktop() {
	...
	if( is.min ){
		...
		if( titleMgr ) {
		  if( !titleMgr.loadTest( '_tobj190', 'test190', 'course_test_1_puppies_page.html' )) {
		...
		if ( trivPageTracking.GetRangeStatus(197) == 'notstarted' ) trivPageTracking.SetRangeStatus(197,2);
	}
}
...
button15.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 954px; top: 17px; width: 26px; height: 30px; z-index: 15; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj15",
	bInsAnc:	1,
	cwObj:		{
...
button12.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 861px; top: 598px; width: 48px; height: 48px; z-index: 16; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj12",
	bInsAnc:	1,
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_page_5.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 941px; top: 598px; width: 48px; height: 48px; z-index: 17; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj9",
	bInsAnc:	1,
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_kitties_page.html',true);
    if(typeof pF == 'function') pF(); }},
...
button199.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 51px; top: 523px; width: 77px; height: 29px; z-index: 18; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj199",
	bInsAnc:	1,
	cwObj:		{
...
button201.rcdData.att_Desktop = 
{
	...
	cssText:	"visibility: inherit; position: absolute; left: 890px; top: 536px; width: 60px; height: 29px; z-index: 19; cursor: pointer;",
	cssClasses:	"",
	htmlId:		"tobj201",
	bInsAnc:	1,
	cwObj:		{
...
text386.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 242px; min-height: 28px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 242px; min-height: 28px;\"><p style=\"text-align:left\"><span style=\"font-family:\'Arial\',sans-serif;font-size:12pt;color:0\">*hint* the answer is true- Duh</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 172px; top: 261px; width: 242px; height: 28px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj386",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[172,261,242,28]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
qu258.rcdData.att_Desktop = 
{
	innerHtml:	"",
	cssText:	"",
	cssClasses:	"",
	...
	cwObj:		{
				...
				"varQuest":	VarQuestion_258
			},
	objData:	{"a":[0,32,0,[]]}
};
text267.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 460px; min-height: 20px;\"><legend><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 460px; min-height: 20px;\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">Puppies are very cute creatures.</span></p></div></legend></div>",
	cssText:	"visibility: inherit; position: absolute; left: 55px; top: 228px; width: 460px; height: 20px; z-index: 9;",
	cssClasses:	"",
	htmlId:		"tobj267",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	objData:	{"a":[0,32,0,[55,228,460,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
image266.rcdData.att_Desktop = 
{
	innerHtml:	"<img src=\"images/puppies.jpg\" style=\"position: absolute; left: 0px; top: 0px; width: 365px; height: 274px; border-style: none;\">",
	cssText:	"visibility: inherit; position: absolute; left: 449px; top: 264px; width: 365px; height: 274px; z-index: 10;",
	cssClasses:	"",
	htmlId:		"tobj266",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	cwObj:		{
				"arChld":
	[
		{type:6,on:0,delay:0, actItem:function(){ LMSTinCanStatement( 'petted', 'puppies')

    if(typeof pF == 'function') pF(); }}
	]
			},
	objData:	{"a":[1,288,0,[449,264,365,274]]}
};
text268.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 43px; min-height: 20px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 43px; min-height: 20px;\"><label for=\"rad269\" style=\"cursor:default\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">True</span></p></label></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 206px; top: 335px; width: 43px; height: 20px; z-index: 11;",
	cssClasses:	"",
	htmlId:		"tobj268",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	objData:	{"a":[0,32,0,[206,335,43,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
radio269.rcdData.att_Desktop = 
{
	innerHtml:	"<div style=\"white-space: nowrap; position: absolute; left: 0px; top: 0px; width: 19px; height: 19px;\"><input type=\"radio\" id=\"rad269\" name=\"rad258\" value=\"True\" onclick=\"VarQuestion_258.set(this.value);qu258.questionUpdated();\" style=\"background-image: url(&quot;images/trivantis-blank.gif&quot;);\"></div>",
	cssText:	"visibility: inherit; position: absolute; left: 177px; top: 335px; width: 19px; height: 19px; z-index: 12;",
	cssClasses:	"",
	htmlId:		"tobj269",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	objData:	{"a":[0,32,0,[177,335,19,19]],"formType":1,"dwFormFlags":0}
};
text270.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 49px; min-height: 20px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 49px; min-height: 20px;\"><label for=\"rad271\" style=\"cursor:default\"><p align=\"left\"><span style=\"font-family:\'Arial\',sans serif;color:#000000;font-size:12pt;\">False</span></p></label></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 206px; top: 365px; width: 49px; height: 20px; z-index: 13;",
	cssClasses:	"",
	htmlId:		"tobj270",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	objData:	{"a":[0,32,0,[206,365,49,20]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
radio271.rcdData.att_Desktop = 
{
	innerHtml:	"<div style=\"white-space: nowrap; position: absolute; left: 0px; top: 0px; width: 19px; height: 19px;\"><input type=\"radio\" id=\"rad271\" name=\"rad258\" value=\"False\" onclick=\"VarQuestion_258.set(this.value);qu258.questionUpdated();\" style=\"background-image: url(&quot;images/trivantis-blank.gif&quot;);\"></div>",
	cssText:	"visibility: inherit; position: absolute; left: 177px; top: 365px; width: 19px; height: 19px; z-index: 14;",
	cssClasses:	"",
	htmlId:		"tobj271",
	bInsAnc:	0,
	fieldsetId:	'fset258',
	objData:	{"a":[0,32,0,[177,365,19,19]],"formType":1,"dwFormFlags":0}
};
rcdObj.pgWidth_Desktop = pgWidth_desktop;
rcdObj.preload_Desktop = ["images/background.png","images/right-normal.png","images/right-over.png","images/right-click.png","images/left-normal.png","images/left-over.png","images/left-click.png","images/exit-normal.png","images/exit-over.png","images/exit-click.png","images/header.png","images/footer.png","images/next-disabled.png","images/back-disabled.png","images/white%20logo.png","images/std_qt__Cancel_normal.gif","images/std_qt__Cancel_over.gif","images/std_qt__Cancel_clicked.gif","images/std_qt__Next_normal.gif","images/std_qt__Next_over.gif","images/std_qt__Next_clicked.gif","images/puppies.jpg"];
