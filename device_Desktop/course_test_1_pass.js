function init_Desktop() {
	...
	if( is.min ){
		...
		if ( trivPageTracking.GetRangeStatus(215) == 'notstarted' ) trivPageTracking.SetRangeStatus(215,2);
	}
}
...
button12.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_last_test_page.html',false);
    if(typeof pF == 'function') pF(); }},
...
button9.rcdData.att_Desktop = 
{
	...
	cwObj:		{
				"arChld":
	[
		{type:6,on:2,delay:0, actItem:function(){ trivExitPage('course_test_1_fail.html',true);
    if(typeof pF == 'function') pF(); }},
...
text307.rcdData.att_Desktop = 
{
	innerHtml:	"<div name=\"dCon\" style=\"position: absolute; left: 0px; top: 0px; width: 596px; min-height: 220px;\"><div name=\"dCon2\" class=\"ttxt\" style=\"left: 0px; top: 0px; width: 596px; min-height: 220px;\"><p style=\"text-align: center;\"><span style=\"font-size: 72pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">You Passed!!</span></p><p style=\"text-align: center;\"><span style=\"font-size: 72pt; color: rgb(0, 0, 0); font-family: Arial, \'sans serif\';\">Yay!</span></p></div></div>",
	cssText:	"visibility: inherit; position: absolute; left: 206px; top: 274px; width: 596px; height: 220px; z-index: 8;",
	cssClasses:	"",
	htmlId:		"tobj307",
	bInsAnc:	0,
	objData:	{"a":[0,32,0,[206,274,596,220]],"dwTextFlags":0,"borderSize":0,"marginSize":0}
};
